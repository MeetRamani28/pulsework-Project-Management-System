...
const EmployeeProfile: React.FC = () => {
  ...
  return (
    <div className="p-4 sm:p-6 bg-gradient-to-br from-blue-50 via-white to-blue-50 min-h-full">
              ...
              <div className="col-span-1 sm:col-span-2">
                ...
                {isEditing ? (
                  <textarea
                    ...
                    className="w-full border border-slate-200 bg-white rounded-xl p-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition text-slate-800 font-medium"
                    rows={4}
                  />
                ) : (
